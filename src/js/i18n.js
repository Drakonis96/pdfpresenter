...
const translations = {
  es: {
    ...
    'videoModal.urlHint': 'Formatos aceptados: youtube.com/watch?v=..., youtu.be/..., youtube.com/embed/... Se insertará como iframe automáticamente. El sonido solo se reproducirá en la pantalla de audiencia.',
  ...
  en: {
    ...
    'videoModal.urlHint': 'Accepted formats: youtube.com/watch?v=..., youtu.be/..., youtube.com/embed/... It will be embedded as an iframe automatically. Sound will only play on the audience screen.',
