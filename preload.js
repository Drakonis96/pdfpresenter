...
contextBridge.exposeInMainWorld('api', {
  ...
  startPresentation: (pdfId, startSlide) => ipcRenderer.invoke('start-presentation', pdfId, startSlide),
  startPresenterMode: (pdfId, startSlide) => ipcRenderer.invoke('start-presenter-mode', pdfId, startSlide),
